...
The interim point is a blue filled circle. The predicted values of theta at the end of the study are indicated by a black tiangle, a blue square, and a blue diamond representing, respectively, the predicted values of theta at the end of the study for (a) the originally prediction, (b) the prediction under the current trend, and (c) the prediction under the assumed trend.

##References

Lan, KKG and Wittes J (1988) The B-value: A tool for monitoring data. `Biometrics` 44, 579-585.

Lachin JM (2005) A review of methods for futility stopping based on conditional power Stati`stics in Medicine` 24, 2747-2764.
